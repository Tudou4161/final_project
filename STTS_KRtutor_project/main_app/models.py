...
class EssentialSentenceDB(models.Model): #필수문장 적재
    ...
    #InnerChapOne = models.ForeignKey(ChapterNumberDB, related_name="essential_sentence", on_delete=models.CASCADE)
    #InnerChapTwo = models.ForeignKey(ChapterNumberDB, related_name="essential_sentence", on_delete=models.CASCADE)
    ChapNo = models.IntegerField()
